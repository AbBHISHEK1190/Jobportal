...
<head>
  ...
  <!-- <link rel="stylesheet" href="{{ URL::asset('assets/plugins/icheck-bootstrap/icheck-bootstrap.css') }}"> -->
  ...
  <!-- @vite(['resources/assets/plugins/icheck-bootstrap/icheck-bootstrap.css','resources/assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css','resources/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css','resources/assets/plugins/jqvmap/jqvmap.min.css','resources/assets/dist/css/adminlte.min.css','resources/assets/dist/css/adminlte.min.css','resources/assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css','resources/assets/plugins/daterangepicker/daterangepicker.css','resources/assets/plugins/summernote/summernote-bs4.min.css']) -->
</head>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" style="background-color:grey" data-controlsidebar-slide="true" href="#" role="button">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
                <a href="{{ url('recruiter/profile') }}" class="nav-link">
...
@endif
  ...
  <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#">Jobportal</a>.</strong>
